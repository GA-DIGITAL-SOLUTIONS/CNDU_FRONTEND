    ...
    <div className="specific_product_page">
      {isLoading ? (
        ...
        <>
            ...
            <div className="details_container">
              ...
              {singleSaree?.product_colors &&
                singleSaree?.product_colors.length > 0 && (
                  <div>
                    {productColorDiscount < productColorPrice &&
                    !(productColorDiscount == 0) ? (
          ...
          <div>
						{ displayedProducts?.length>0 &&  <div className="related-products-container">
              ...
              <div className="related-products-list">
                {displayedProducts?.map((product) => {
                  ...
                  const productUrl =
                    product?.category?.name.toLowerCase() === "sarees"
                      ? `/products/${product?.id}`
