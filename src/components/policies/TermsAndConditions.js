				...
				<div className="terms-content">
					<section>
						...
						<ul>
							...
							<li>
								...
								“We”, “Us” or “Our” in this Agreement) refers to cndu fabrics,
								Gajularamaram Road, Prakasham Panthulu Nagar, Hyderabad,
								Telangana 500019.
							</li>
							<li>
							...
							<li>
								<strong>Website</strong> refers to cndu fabrics, accessible from{" "}
								<a href="https://cndu.in/">https://cndu.in/</a>.
							</li>
							<li>
					...
					<section>
						...
						<p>
							...
							on this page and updating the “Last updated” date at the top of
							these Terms and Conditions.
						</p>
						<p>
							You are advised to review these Terms and Conditions periodically
							for any changes. Changes to these Terms and Conditions are
					...
					<section>
						...
						<ul>
							<li>By email: cndufabrics@gmail.com</li>
							<li>
							...
							<li>
								By Visiting: Gajularamaram Road, Prakasham Panthulu Nagar,
